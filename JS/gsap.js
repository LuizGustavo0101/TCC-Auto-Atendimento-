...
tl.to(".bola2", {y:-60, duration:1, repeat:-1, delay:0.1, yoyo: true, ease: "easeOut"}, "<");
tl.to(".bola3", {y:-60, duration:1, repeat:-1, delay:0.2, yoyo: true, ease: "easeOut"}, "<");
tl.to(".bola4", {y:-60, duration:1, repeat:-1, delay:0.3, yoyo: true, ease: "easeOut"}, "<");
tl.to(".bola5", {y:-60, duration:1, repeat:-1, delay:0.3, yoyo: true, ease: "easeOut"}, "<");
